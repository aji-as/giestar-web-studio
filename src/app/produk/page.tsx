...
import { Search, X, ArrowUpRight, ArrowRight, ShoppingBag, FileCode2, ExternalLink, ChevronDown } from "lucide-react";
import { Nav } from "@/components/Nav";
import { HeroWave } from "@/components/HeroWave";
import { Footer } from "@/components/Footer";
import { formatIDR, waLink, type ProductRow, supabase } from "@/lib/supabase";
      ...
      <HeroWave>
        <div className="mx-auto max-w-7xl px-6 pt-32 pb-20">
          ...
          <h1 data-load className="mt-5 text-5xl md:text-7xl font-bold tracking-tight text-balance max-w-4xl leading-[0.95]">
            Template <span className="font-serif italic text-yellow-300">website</span>, untuk bisnis & UMKM Anda.
          </h1>
          ...
          <div data-load className="mt-10 flex flex-col sm:flex-row gap-3">
            ...
            <div className="relative min-w-[200px]">
              ...
              >
                {catLoading ? (
                  <option className="bg-slate-950 text-white">Memuat kategori...</option>
                ) : (
                  categories.map((c) => (
